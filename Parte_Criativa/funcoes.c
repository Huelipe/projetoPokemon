 ...
 * @param totalPokesNaColecao variavel que salva o numero total de pokemons da colecao
 * @param listaPokemon vetor dinamico da estrutura Pokemon no qual sera salvo todas as informacoes de cada pokemon da pokedex
 * @param numeroDePokemons variavel que indica o numero total de pokemons
 */
 ...
 * @param totalMochila 
 */
void InserirNaMochila(Mochila* mochila, Colecao* colecaoDePokemons, int *totalPokeColecao, Pokemon* listaPokemon, int totalPokemons, int* totalMochila, pokemonCapturado pokemonASerInserido){
    ...
    switch(PosicaoNoVetor){
        ...
        if(ConfereInserido == 0){
                printf("\nPokémon nao encontrado na coleção!\n");
        }
...
//Define todas as 25 naturezas do jogo
    strcpy(natures[0].nome, "Hardy");
    strcpy(natures[1].nome, "Docile");
    strcpy(natures[2].nome, "Bashful");
    strcpy(natures[3].nome, "Quirky");
    strcpy(natures[4].nome, "Serious");;
    strcpy(natures[5].nome, "Bold");
    strcpy(natures[6].nome, "Modest");
    strcpy(natures[7].nome, "Calm");
    strcpy(natures[8].nome, "Timid");
    strcpy(natures[9].nome, "Lonely");
    strcpy(natures[10].nome, "Mild");
    strcpy(natures[11].nome, "Gentle");
    strcpy(natures[12].nome, "Hasty");
    strcpy(natures[13].nome, "Adamant");
    strcpy(natures[14].nome, "Impish");
    strcpy(natures[15].nome, "Careful");
    strcpy(natures[16].nome, "Jolly");
    strcpy(natures[17].nome, "Naughty");
    strcpy(natures[18].nome, "Lax");
    strcpy(natures[19].nome, "Rash");
    strcpy(natures[20].nome, "Naive");
    strcpy(natures[21].nome, "Brave");
    strcpy(natures[22].nome, "Relaxed");
    strcpy(natures[23].nome, "Quiet");
    strcpy(natures[24].nome, "Sassy");

    float comum = 1;
    float mais = 1.1;
    float menos = 0.9;

    natures[0].modAtk = natures[0].modDef = natures[0].modSpatack = natures[0].modSpdef = natures[1].modSpeed = comum;
    ...
    natures[4].modAtk = natures[4].modDef = natures[4].modSpatack = natures[4].modSpdef = natures[4].modSpeed = comum;
        natures[5].modDef = mais;
            natures[5].modAtk = menos;
                natures[5].modSpdef = natures[5].modSpatack = natures[5].modSpeed = comum;
        natures[6].modSpatack = mais;
            natures[6].modAtk = menos;
                natures[6].modSpdef = natures[6].modDef = natures[6].modSpeed = comum;
        natures[7].modSpdef = mais;
            natures[7].modAtk = menos;
                natures[7].modDef = natures[7].modSpatack = natures[7].modSpeed = comum;
        natures[8].modSpeed = mais;
            natures[8].modAtk = menos;
                natures[8].modSpdef = natures[8].modSpatack = natures[8].modDef = comum;
        natures[9].modAtk = mais;
            natures[9].modDef = menos;
                natures[9].modSpdef = natures[9].modSpatack = natures[9].modSpeed = comum;       
        natures[10].modSpatack = mais;
            natures[10].modDef = menos;
                natures[10].modSpdef = natures[10].modAtk = natures[10].modSpeed = comum;
        natures[11].modSpdef = mais;
            natures[11].modDef = menos;
                natures[11].modAtk = natures[11].modSpatack = natures[11].modSpeed = comum;
        natures[12].modSpeed = mais;
            natures[12].modDef = menos;
                natures[12].modSpdef = natures[12].modSpatack = natures[12].modAtk = comum;
        natures[13].modAtk = mais;
            natures[13].modSpatack = menos;
                natures[13].modSpdef = natures[13].modDef = natures[13].modSpeed = comum;
        natures[14].modDef = mais;
            natures[14].modSpatack = menos;
                natures[14].modSpdef = natures[14].modAtk = natures[14].modSpeed = comum;
        natures[15].modSpdef = mais;
            natures[15].modSpatack = menos;
                natures[15].modDef = natures[15].modAtk = natures[15].modSpeed = comum;
        natures[16].modSpeed = mais;
            natures[16].modSpatack = menos;
                natures[16].modSpdef = natures[16].modAtk = natures[16].modDef = comum;
        natures[17].modAtk = mais;
            natures[17].modSpdef = menos;
                natures[17].modDef = natures[17].modSpatack = natures[17].modSpeed = comum;
        natures[18].modDef = mais;
            natures[18].modSpdef = menos;
                natures[18].modAtk = natures[18].modSpatack = natures[18].modSpeed = comum;
        natures[19].modSpatack = mais;
            natures[19].modSpdef = menos;
                natures[19].modAtk = natures[19].modDef = natures[19].modSpeed = comum;
        natures[20].modSpeed = mais;
            natures[20].modSpdef = menos;
                natures[20].modAtk = natures[20].modDef = natures[20].modSpatack = comum;
        natures[21].modAtk = mais;
            natures[21].modSpeed = menos;
                natures[21].modSpdef = natures[21].modSpatack = natures[21].modDef = comum;
        natures[22].modDef = mais;
            natures[22].modSpeed = menos;
                natures[22].modSpdef = natures[22].modSpatack = natures[22].modAtk = comum;
        natures[23].modSpatack = mais;
            natures[23].modSpeed = menos;
                natures[23].modSpdef = natures[23].modAtk = natures[23].modDef = comum;
        natures[24].modSpdef = mais;
            natures[24].modSpeed = menos;
                natures[24].modAtk = natures[24].modSpatack = natures[24].modDef = comum;
}
