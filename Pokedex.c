...
int main() {
    ...
    arquivo = fopen("C:/Users/Huelipe/Documents/PokemonVSCODE/pokedex.csv", "r"); // Substitua "seuarquivo.csv" pelo nome do seu arquivo CSV
    ...
    while (fgets(linha, sizeof(linha), arquivo)) {
        ...
        // Repita para os outros membros da estrutura
